...
<table width="100%" align="center">
  <tr>
    <td><form action="uploadsparsemp.php" method="post" enctype="multipart/form-data" name="form1">
      <table width=70% border=0 align="center">
        <tr>
          <td width=25% height="472" align=left valign=top><p align="right"><a href="index3.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a><a href="home.php"></a></p>
              <table width="190" border="0" align="right">
                ...
                <tr>
                  <td class="style2"><ul>
                      ...
                      <li>
                        <div align="left"><a href="examplesw.php" class="style8">test examples Weighted Inverse</a><a href="primer.php" class="style8"></a> <a href="primer.php" class="style8"></a>                  </div>
                      </li>
                  </UL></td>
                </tr>
            </table></td>
          <td width=75% valign=top align=left><table width=100% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  ...
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% align=left valign=top><h1 align="left" class="style3"><span class="style35"><span class="style33"><br>
              ...
              <tr>
                <td height="367" align=left valign=top><table width="100%" height="157" border="0" align="center" bgcolor="#FFFFFF">
                      ...
                      <td height="34" colspan="3" bgcolor="#FFFFFF"><h3 class="style13"><br>
                        ...
                        <ul class="style2">
                          ...
                          <li class="style29">Click on the button Browse.. and find file with the <a href="testmatrix.php">matrices</a> on your computer<br>
                            <br>
                          <li class="style29">Only click <span class="style21">Calculate</span> and engoy
                        </ul>                        </td>
                      </tr>
                    <tr bgcolor="#FF5604">
                      <td height="26" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix A</div></td>
                      </tr>
                    <tr>
                      <td width="51%" height="43" align="center" valign="middle"><div align="left"><span class="style1 style4 style23">
                        <input type="hidden" name="action" value="upload" />
                        </span>
                          <input type="file" name="userfile" id="userfile">
                      </div>
                      <label></label></td>
                      <td width="48%" align="left" valign="middle"><label>
                        </label></td>
                    </tr>
                    <tr bgcolor="#FF5604">
