...
<table width="100%" align="center">
  <tr>
    <td><form action="<?php echo "uploadMP.7del.php?m1=$m1&n1=$n1&m2=$m2&n2=$n2&zielkeA=$zielkeA&zielkeB=$zielkeB&famous=$famous&famous2=$famous2&skalarr=$r&skalars=$s&skalarp=$p&skalarq=$q";?>" method="post" enctype="multipart/form-data" name="form1">
      <table width=98% border=0 align="center">
        <tr>
          <td width=25% height="472" align=left valign=top><table width="70" border="0" align="right">
                
                <tr>
                  <td align="right" valign="top"><a href="index.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></td>
                </tr>
                <tr>
                  <td align="right" valign="top" class="style2"><span class="style15"><img src="images/liner.gif" alt="" width="200" height="1"></span></td>
                </tr>
                <tr>
                  <td width="216"><!-- *** MyCSSMenu copyright (c) 2007, MyCSSMenu. All Rights Reserved.
          ...
          <td width=75% valign=top align=left><table width=92% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  ...
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% height="178" align=left valign=top><h1 align="left" class="style3"><span class="style26"><span class="style38">The Matrix Library</span><br>
                      </span></h1>
              ...
              <tr>
                <td height="367" align=left valign=top><table width="96%" height="48" border="0" align="center" bgcolor="#FFFFFF">
                    ...
                    <tr bgcolor="#FF5604">
                      <td width="100%" height="21" align="left" valign="top" bgcolor="#FFFFFF"><p class="style3 style5"><span class="style26">
...
?>
                    ...
                    <tr bgcolor="#FF5604">
                      <td height="21" align="left" valign="top" bgcolor="#FFFFFF"><table width="300" align="center">
                        <tr>
