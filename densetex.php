...
<table width="100%" align="center">
  <tr>
    <td><form action="densetex1.php" method="post" enctype="multipart/form-data" name="form1">
...
/*!!!!!!!!!!! MyCSSMenu Styles [Please Modify!] !!!!!!!!!!!*/
	...
	{	
		...
		a.tree_collapse_step_size = 15;
                      ...
                      <body style="margin:40px;background-color:#ffffff;">
                      <noscript>
                      </noscript>
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script><p>&nbsp;</p>
          ...
          <td width=75% valign=top align=left><table width=92% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  ...
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% height="203" align=left valign=top><h1 align="left" class="style3"><br>
              ...
              <tr>
                <td height="367" align=left valign=top><table width="93%" height="640" border="0" align="center" bgcolor="#FFFFFF">
                    ...
                    <tr bgcolor="#FF5604">
                      <td height="26" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center" class="style34">
                        <div align="left">insert matrix A</div>
                      </div></td>
                      <td height="26" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left"><span class="style34">insert matrix B</span></div></td>
                      </tr>
                    <tr>
                      <td height="148" colspan="2" align="center" valign="middle" class="style22"><label>
                        <div align="left">
                          <textarea name="textarea" id="textarea" cols="40" rows="7" style="overflow: scroll; overflow-y: scroll; overflow-x: scrool; background:#fffcf0"></textarea>
                        </div>
                      </label></td>
                      <td colspan="2" align="center" valign="middle" class="style22"><label>
                        <div align="left">
                          <textarea name="textarea2" id="textarea2" cols="40" rows="7" style="overflow: scroll; overflow-y: scroll; overflow-x: scrool; background:#fffcf0"></textarea>
                          </div>
                      </label></td>
                      </tr>
                    ...
                    <tr bgcolor="#FF5604">
                      <td width="24%" height="8" bgcolor="#FFFFFF"><div align="right"><span class="style40">Values are delimited by:</span></div></td>
                      ...
                      <td width="27%" height="8" bgcolor="#FFFFFF"><div align="right"><span class="style40">Values are delimited by:</span></div></td>
