...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script>&nbsp;</td>
    ...
    <td width=77% height="158" align=left valign=top><h1 align="left" class="style3"><span class="style35"><span class="style33">      The Matrix Library</span><br />
    </span></h1>
...
$n=$p;
$kljuc = $idA;
$matrix_out=solution_exist($idA);
if($matrix_out){
	prikaz_kad_nema($matrix_out,$n,$m);
//	echo "<br>";
//	echo "<br>";
...
//	echo $time_end - $time_start;
	...
	header("Location:vezaMP.147d.php?t=$t&p=$p&time_start=$time_start&idA=$idA");
?></td>
        </tr>
        <tr>
          <td><div align="center">
