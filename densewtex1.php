...
.style46 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 15px; color: #FF0000; }
...
<form name="form1" method="post" action="<?php echo "uploadwexam.php?textw=1";?>">
  <table width="95%" align="center" >
    <tr bgcolor="#FFFFFF">
      <td width="23%" rowspan="3" align="left" valign="top"><p align="right"><a href="index.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></p>
        <table width="70" border="0" align="right">
          ...
          <tr>
            <td valign="top" class="style2"><p>&nbsp;</p>
              <p><!-- *** MyCSSMenu copyright (c) 2007, MyCSSMenu. All Rights Reserved.
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script>&nbsp;</p></td>
          </tr>
          <tr>
      ...
      <td height="194" colspan="2" align=left valign=top><h1 align="left" class="style3"><span class="style26"><span class="style38"><br>
    ...
    <tr bgcolor="#FFFFFF">
      <td colspan="2" align="left" valign="top"><p class="style3 style5"><span class="style26">
        <?php  echo "matrix A"; ?>
      </span></p>
        <div align="left">
<?php
...
?>
        ...
        <div align="left">
<?php
    if($select3 == 'Commas') $textarea3 = str_replace(","," ",$textarea3);
	$matrixc=textarea($textarea3);
	$matrixc = implode(",",$matrixc);
	prikaz_resenja($matrixc,$n1,$n1);
?>
      </div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td colspan="4" align="center" valign="middle"><table width="300" align="center">
        ...
        <tr>
          ...
          <td><input type="hidden" name="textarea2" id="textarea2" value="<?php echo $textarea2;?>"></td>
          <td><span class="style22">
            <input type="hidden" name="textarea3" id="textarea3" value="<?php echo $textarea3;?>">
          </span></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
