...
<table width="100%" align="center">
  <tr>
    <td><form action="examplesmp1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
              ...
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  ...
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% height="208" align=left valign=top><h1 align="left" class="style3"><span class="style35"><span class="style33"><br />
              ...
              <tr>
                <td height="367" align=left valign=top><table width="100%" height="169" border="0" align="left" bgcolor="#FFFFFF">
                    ...
                    <tr>
                      ...
                      <td width="16%" align="center" valign="middle"><div align="left"><input name="m1" type="text" id="m1" size="5">
                          </div>
                      </label></td>
