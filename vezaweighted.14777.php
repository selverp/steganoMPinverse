...
echo $procenat . "%";?>" align="center" >
  <tr bgcolor="#FFFFFF">
    <td width="22%" rowspan="4" align="right" valign="top"><table width="70" border="0" align="right">
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script>&nbsp;</td>
    ...
    <p>&nbsp;</p></td>
    <td width="1%" rowspan="4" valign="top"><p>&nbsp;</p>
      <p align="left"><br>
        <br>
      </p>
    ...
    <td width=77% height="186" align=left valign=top><h1 align="left" class="style3"><span class="style35"><span class="style33">      The Matrix Library</span><br />
    </span></h1>
  ...
  <tr bgcolor="#FFFFFF">
    <td align="left" valign="top"><p class="style3 style5"><br>
        <span class="style36">Weighted inverse</span></p>
      <table width="388">
        <tr>
          <td colspan="3"><?php
//prikaz matrice A iz baze, u napravljene u obliku niza
$matrixad=makeDvodim($idA,$t,$p);

//prikaz matrice M iz baze, u napravljene u obliku niza
$matrixbd=makeDvodim($idB,$t,$t);

//prikaz matrice N iz baze, u napravljene u obliku niza
$matrixcd=makeDvodim($idC,$p,$p);
$Weighted=WeightedInverse($matrixbd,$matrixad,$matrixcd);
$idK= $idA . "." . $idB . "." . $idC; 
createXML($p,$t,$idK,$Weighted);
unos_weighted($Weighted,$t,$p,$idA,$idB,$idC,'W');
//print_r($Weighted);
//echo $time_end - $time_start;
//print_r($Weighted);
$Weighted = makeJeddim($Weighted,$p,$t);
prikaz_kad_nema($Weighted,$t,$p);
//echo $n;
?></td>
        </tr>
        <tr>
