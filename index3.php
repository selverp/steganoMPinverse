...
<HTML>
<HEAD><TITLE>MATRIX operation</TITLE><link rel="shortcut icon" href="images2/PMF_logo.ico" type="image/x-icon">
...
var typespeed = 150;
  var MessagePause = 5000;
  var message = new Array();
  var currMessage = 0;
  var offset = 0;

  message[0] = " Enjoy the calculations with matrices! ";
  message[1] = " Matrix calculator ";
  message[2] = " Enjoy the calculations with matrices! ";
...
<body bgcolor="#FFFFFF" TEXT="#171717" LINK="#C73100" VLINK="#EA6A13" ALINK="#EA6A13">

<table width=844 border=0 align="center">
<tr>
<td width=25% height="635" align=right valign=top><p align="right"><a href="index.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></p>
...
<td width=75% valign=top align=left><table width=100% border=0 align="left">
  <tr>
    ...
    <td width=98% align=left valign=top><h1 align="left" class="style3"><br>
        <span class="style26"><span class="style33">The Matrix Library</span><br>
        </span></h1>
      <h3 align="left" class="style10">Matrix algebra: matrix product, determinants, inverses, pawers of matrices, arithmetic, MP and Weighted inverse</h3>      </td>
    </tr>
  <tr>
    <td align=left valign=top><img src="images/linel.gif" width="200" height="1"></td>
  </tr>
  <tr>
    <td align=left valign=top><h3 class="style13"><span class="style28"><br>
      The instructions:</span><br>
    </h3>
      <ul class="style2">
        ...
        or<br>
        <br>
        <li class="style29"> Type number rows and&nbsp;columns of matrices end enter elements; blank entries are set to zero<br>
          <br>        
        ...
        <li class="style29">Chose operation power of A, power of B, matrix product, transpose, determinants or inverse
          from List/Menu and click <span class="style32">Calculate</span>, or<br>
          <br>      
        <li class="style29">Only click <span class="style21">Calculate</span> for chosen the MP and the Weighted inverse, from menu on the left side. 
        </ul>
      <table width="100" align="center">
        ...
        <tr>
          <td colspan="10" class="style3 style29">chack operations:</td>
          </tr>
        <tr>
          <td colspan="10"><table width="577">
              <tr>
                <td width="103" height="31"><div align="left">
  ...
  <td height="38" colspan="2" align=left valign=top><table width=581 border=0 align="center">
    <tr>
      <td align=left valign=top><div align="center">
            <p class="style2">&nbsp;&nbsp;<span class="style17"><span class="style6">&nbsp;&nbsp;</span></span><span class="style34"><span class="style35">&nbsp;|&nbsp;&nbsp;&nbsp;</span></span><span class="style35"><A HREF="#">FAQs</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp; <A HREF="#">legal</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp; <A HREF="kontakt/mailform.php">email us</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp; <A HREF="sparse.php">sparse</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span> <span class="style35"><A HREF="dense.php">dense</A>&nbsp;&nbsp;&nbsp;|&nbsp;</span><span class="style6">&nbsp;&nbsp;</span>&nbsp;<BR>
                <br>
                <span class="style18"><span class="style29"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copyright &reg; 2009 Selver H. Pepic  Inc. All rights reserved&nbsp;</span>&nbsp;</span><span class="style19">&nbsp;&nbsp;&nbsp;</span></p>
      </div></td>
    </tr>
