...
echo $procenat . "%";?>" align="center" >
  <tr bgcolor="#FFFFFF">
    <td width="24%" rowspan="3" align="right" valign="top"><p align="right"><a href="index.php"><img src="images/logoi2.gif" alt="home page" width="199" height="185"></a></p>
      <table width="213" border="0" align="right">
        
        <tr>
          <td width="214" class="style15">&nbsp;</td>
        </tr>
        <tr>
          <td class="style2"><ul>
              <LI>
    ...
    <td width="1%" rowspan="3" valign="top"><p>&nbsp;</p>
      <p align="left"><img src="fadeup.gif" width="1" height="92"></p>
    <p align="left"><img src="fadedn_bluethin.gif" width="1" height="200"></p></td>
    <td width=75% align=left valign=top><h1 align="left" class="style3"><br>
      </h1>
        <h1 align="left" class="style3"><br>
          Matrix Automatic Calculus and Algebra Help</h1>
    <h3 align="left" class="style10">derivatives, integrals, graphs, linear equations, matrix algebra</h3></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td valign="middle"><img src="linel.gif" width="200" height="1"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="left" valign="top"><p align="left" class="style3 style5"><br>
      Weighted inverse</p>
      <div align="left">
      <?php
...
$inverz='LM';
$postoji=prikaz_weighted($idA,$idB,$idC,$m,$n,$inverz);
if(!$postoji)
	header("Location:vezalm.1477.php?m=$m&n=$n&time_start=$time_start&idA=$idA&idB=$idB&idC=$idC");
else{
