...
.style35 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; color: #FF0000; }
.style36 {color: #9900CC}
-->
</style>
</HEAD>
...
<tr>
<td width=25% height="635" align=left valign=top><table width="70" border="0">
    ...
    <tr>
      <td width="190" height="3" align="right" valign="top" class="style15"><img src="images/liner.gif" width="200" height="1"></td>
    </tr>
    <tr>
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script>&nbsp;</td>
  ...
  <span class="style15"><a href="index3.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></span></td>
<td width=75% valign=top align=left><table width=100% border=0 align="center">
  <tr>
    ...
    <td width=98% align=left valign=top><h1 align="left" class="style3"><span class="style26"><span class="style34">The Matrix Library</span><br>
        </span></h1>
  ...
  <tr>
    <td align=left valign=top><h3><br>
      <span class="style21">Enter matrix elements, in <strong><span class="style36">txt</span></strong> file, row by row, seperated by space <strong> sign</strong>.</span><BR>
          <br>
          <br>
          &nbsp;&nbsp;<img src="images/testmatrix.gif" alt="test matrix" width="246" height="198"></h3>
      <div align="center">
        <div align="left"></div>
      </div>
      <h3 class="style13"><br>
