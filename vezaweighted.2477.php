...
echo $procenat . "%";?>" align="center" >
  <tr bgcolor="#FFFFFF">
    <td width="25%" rowspan="3" align="right" valign="top"><p align="right"><img src="images/logoi2.gif" alt="home page" width="199" height="185"></p>
      <table width="212" border="0" align="right">
    ...
    <td width=74% align=left valign=top><h1 align="left" class="style3"><br>
      </h1>
...
{	
	...
	for($i=0;$i<$novam*$novan;$i=$i+$novan)
	{
		for($j=$i;$j<$i+$novan;$j++)
		{
			...
			echo "<input name=a[] type=text size=\"2\" maxlength=\"5\" value=\"$zaok\"  readonly=\"readonly\"> ";
		}
		echo "<br>";
	}
