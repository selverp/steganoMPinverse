	...
	if((fup.value || fup2.value)){	
		if((varithmetic!=0 || vpowersa!=0 || vpowersb!=0 || vproducts!=0 || vtranspose!=0 || vdeterminants!=0 || vinverses!=0)){
			if(!k && !k2 && !k3 && !k4){
				...
				if(varithmetic == 6 && (!fup2.value || isblank(skalars.value))){ 
				...
				if((varithmetic == 1 || varithmetic == 2 || varithmetic == 3 || vinverses == 4 || vinverses == 5 || vproducts == 1 || vproducts == 2 || vproducts == 4 || vproducts == 5 || vproducts == 7 || vproducts == 8 || vproducts == 10 || vproducts == 11 || vtranspose == 4 || vtranspose == 5 || vtranspose == 7 || vtranspose == 8 || vdeterminants == 9 || vdeterminants == 10 || vdeterminants == 18 || vdeterminants == 19) && !(fup.value && fup2.value)){ 
					alert("Please enter matrces A and B!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if(varithmetic == 7 && (!(fup.value && fup2.value)|| isblank(skalarr.value) || isblank(skalars.value))){
					alert("Please enter scalars r and s and matrices A and B!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if((vinverses == 16 || vdeterminants == 12 || vdeterminants == 13) && (!(fup.value && fup2.value)|| isblank(skalarp.value) || isblank(skalarq.value))){
					alert("Please enter scalars p and q and matrices A and B!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if(vpowersa == 8 && (!(fup.value)|| isblank(skalarp.value) || isblank(skalarq.value))){
					alert("Please enter scalars p and q and use matrix A!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if(vpowersb == 8 && (!(fup2.value)|| isblank(skalarp.value) || isblank(skalarq.value))){
					alert("Please enter scalars p and q and use matrix B!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if((vinverses == 13 || vdeterminants == 3) && (!(fup.value)|| isblank(skalarp.value))){
					alert("Please enter scalar p and use matrix A!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if((vinverses == 14 || vdeterminants == 7) && (!(fup2.value)|| isblank(skalarq.value))){
					alert("Please enter q and use matrix B!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if((vpowersa != 0) && !(fup.value)){
					alert("Please enter matrix A!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if((vpowersb != 0) && !(fup2.value)){
					alert("Please enter the matrix B!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
...
.style4 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 24; }
.style6 {
	font-family: Verdana, Arial, Helvetica, sans-serif;
	font-size: 12px;
	font-weight: bold;
...
.style13 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; color: #9900CC; }
.style15 {
	font-family: Verdana, Arial, Helvetica, sans-serif;
	color: #0000FF;
	font-weight: bold;
...
.style32 {color: #FF0000; font-family: Verdana, Arial, Helvetica, sans-serif;}
.style34 {color: #0000FF; font-size: 14px; font-family: Verdana, Arial, Helvetica, sans-serif;}
.style35 {font-size: 13px; color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif; }
.style36 {color: #999999; font-size: 13px; }
.style38 {font-size: 12px; color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif; }
.style18 {	color: #999999;
	font-size: 14px;
}
.style42 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #FF0000; font-weight: bold; }
-->
</style>
</HEAD>
...
<table width="100%" align="center">
  <tr>
    <td><form action="<?php echo "dproba.php?nacin=$nacin";?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <table width=70% border=0 align="center">
        <tr>
          <td width=25% height="472" align=left valign=top><p align="right"><a href="index3.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></p>
              <table border="0" align="right">
                <tr>
                  <td width="443" valign="top" class="style15"><img src="images/liner.gif" alt="" width="200" height="1"></td>
                </tr>
                <tr>
...
<ul id="qm0" class="qmmc">
	...
	<li><a class="qm-startopen qmparent" href="index3.php">DENSE matrix</a>
	...
	<li><a class="qmparent" href="index3.php">SPARSE matrix</a>

		<ul>
		<li><a class="qmparent" href="dense.php">Matrix manipulation</a>
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script><p>&nbsp;</p>
          ...
          <td width=75% valign=top align=left><table width=100% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% height="207" align=left valign=top><h1 align="left" class="style3"><span class="style30"><br>
                      The Matrix Library</span><span class="style26"><br>
                      </span></h1>
                    <h3 align="left" class="style10">Matrix algebra: matrix product, determinants, <br>
                  inverses, pawers of matrices, arithmetic, MP and Weighted inverse</h3></td>
              </tr>
              <tr>
                <td height="4" align=left valign=top><img src="images/linel.gif" width="200" height="1"></td>
              </tr>
              <tr>
                <td height="367" align=left valign=top><table width="100%" height="222" border="0" align="center" bgcolor="#FFFFFF">


                    <tr bgcolor="#FF5604">
                      <td height="34" colspan="3" bgcolor="#FFFFFF"><h3 class="style13"><br>
                        <span class="style28">The instructions:</span><br>
                      </h3>
                        <ul class="style2"><li class="style29">Click on the button Browse.. and find file with the <a href="testmatrix.php">matrices</a> on your computer<br>
            <br>
                          <li class="style29"> Chack chackbox if matrix is test<br>
                              <br>
                          <li class="style29">Type whole numbers 
                            in fields s, r, p and q, if you want<br>
              <br>
                          <li class="style29">Chose operation power of A, power of B, matrix product, transpose, determinants or inverse
                            from List/Menu and click <span class="style32">Calculate</span>                          
                        </ul>                        </td>
                      </tr>
                    <tr bgcolor="#FF5604">
                      <td height="26" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF" class="style21">
                      <?php 
					  	  if($agree==11)
					  	 	 echo "Dimensions of the matrices must be correct!";
						  elseif($agree==2)
						  ...
						  if($agree==7)
					  	 	 echo "Matrix must be square!";
							 if($agree==8)
					  	 	 echo "Enter the matrices and chose operation!";
						
					  ?>
                      </td>
                      </tr>
                    <tr bgcolor="#FF5604">
                      <td height="26" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center" class="style34">
                        <div align="left" class="style29">insert matrix A</div>
                      </div></td>
                      <td width="50%" height="26" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center" class="style34">
                        <div align="left" class="style29">insert matrix B</div>
                      </div></td>
                    </tr>
                    <tr>
                      <td width="49%" height="43" align="center" valign="middle"><div align="left"><span class="style1 style4 style23">
                      ...
                      <td align="left" valign="middle"><div align="left">
                        <label> <span class="style1 style4 style23">
                        <input type="hidden" name="action2" value="upload" />
                        </span>
                    ...
                    <tr bgcolor="#FF5604">
                      <td height="28" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left">
                        <input type="checkbox" name="zielkeA" id="zielkeA">
                        <span class="style35">check if test matrix</span></div></td>
                      <td height="28" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left">
                        <input type="checkbox" name="zielkeB" id="zielkeB">
                        <span class="style35">check if test matrix</span></div></td>
                      <td width="1%" height="28" align="left" valign="top" bgcolor="#FFFFFF" class="style26">&nbsp;</td>
                    </tr>
                    <tr bgcolor="#FF5604">
                      <td height="28" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left"></div></td>
                      <td height="28" align="left" valign="top" bgcolor="#FFFFFF" class="style26">&nbsp;</td>
                    </tr>
                    
                    <tr bgcolor="#FF5604">
                      <td height="21" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="70%" align="left">
                        <tr>
                          <td width="4%" class="style22"><div align="right" class="style25">
                            <div align="left">r&nbsp;=&nbsp;</div>
                          </div></td>
                          <td width="10%"><div align="left" class="style20">
                              <div align="left">
                                <input name="skalarr" type="text" class="style22" id="skalarr" size="4"/>
                                  </div>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">
                          ...
                          <td width="10%"><div align="left" class="style20">
                              <div align="left">
                                <input name="skalars" type="text" class="style22" id="skalars" size="4"/>
                                  </div>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">
                          ...
                          <td width="10%"><div align="left" class="style20">
                              <div align="left">
                                <input name="skalarp" type="text" class="style22" id="skalarp" size="4" />
                                  </div>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">
                          ...
                          <td width="10%"><div align="left" class="style20">
                              <div align="left">
                                <input name="skalarq" type="text" class="style22" id="skalarq" size="4" />
                                  </div>
                          </div></td>
                          <td width="44%" colspan="2" class="style22"><div align="left"></div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td colspan="10"><table width="100%" align="left">
                              <tr>
                                <td width="4" height="31"><div align="left">
                                ...
                                <td>
                                  <div align="left">
                                    <select name="determinants" class="style21" id="determinants">
                                      ...
                                      <option value="noop"> </option>
                                      <option value="det[A^-1.B]">det[A^-1 . B] </option>
                                      <option value="det[B^-1.A]">det[B^-1 . A] </option>
                                    </select>
                                    </div></td>
                                <td><div align="left">
                  ...
                  <table width="90%">
                    <tr>
                      <td width="84%"><div align="left"><span class="style38">Select on or more operations to be perfored and click Calculate!</span></div></td>
        ...
        <tr>
          <td colspan="2" align=left valign=top><table width=581 border=0 align="center">
            <tr>
              <td align=left valign=top><div align="center">
                  <p><span class="style2">&nbsp;&nbsp;<span class="style17"><span class="style6">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span></span><span class="style6"><A HREF="#">FAQs</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp; <A HREF="#">legal</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp; <A HREF="kontakt/mailform.php">email us</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp; <A HREF="sparse.php">sparse</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span> <span class="style6"><A HREF="dense.php">dense</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>&nbsp;<BR>
                        <br>
                        <span class="style18"><span class="style29"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copyright &reg; 2011 Selver H. Pepic  Inc. All rights reserved&nbsp;</span>&nbsp;</span><span class="style19">&nbsp;&nbsp;&nbsp;</span></span></p>
              </div></td>
            </tr>
          </table></td>
        </tr>
