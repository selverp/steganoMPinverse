...
.style37 {color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;}
...
<form name="form1" method="post" action="<?php echo "uploadMP.7del.php?m1=$m1&n1=$n1&zielkeA=$famous&r=$r&s=$s&p=$p&q=$q";?>">
  <table width="93%" align="center" >
    <tr bgcolor="#FFFFFF">
      <td width="22%" rowspan="3" align="left" valign="top"><table width="70" border="0" align="right">
          
          <tr>
            <td align="right" valign="top"><a href="index3.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></td>
          </tr>
          <tr>
            <td width="190" align="right" valign="top" class="style15"><img src="images/liner.gif" alt="" width="200" height="1"></td>
          </tr>
          <tr>
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script>&nbsp;</td>
      ...
      <td height="130" colspan="2" align=left valign=top><h1 align="left" class="style3"><span class="style31"><span class="style33">        The Matrix Library</span><br>
      </span></h1>
    ...
    <tr bgcolor="#FFFFFF">
      <td colspan="2" align="left" valign="top"><p class="style13">
        <? if($m1!=null and $n1!=null) echo "matrica A"; ?>
      </p>
        <p class="style13">&nbsp; </p>
      <div align="left">
            <?php
...
?>
        ...
        <p><span class="style13"><? if($m2!=null and $n2!=null) echo "matrica B"; ?></span></p>
        <div align="left">
            <?php
