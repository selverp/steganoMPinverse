		...
		if((varithmetic!=0 || vpowersa!=0 || vpowersb!=0 || vproducts!=0 || vtranspose!=0 || vdeterminants!=0 || vinverses!=0)){
			if(!k && !k2 && !k3 && !k4){
				...
				if(varithmetic == 7 && (!(fup && fup2)|| isblank(skalarr.value) || isblank(skalars.value))){
					alert("Please enter scalars r and s and use matrices A and B!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if((varithmetic == 1 || varithmetic == 2 || varithmetic == 3 || varithmetic == 7) && !(vn2.value==vn1.value && vm2.value==vm1.value)){
					alert("Dimensions of the matrices mast be equal!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				if((vinverses == 16 || vproducts == 14 || vproducts == 13 || vdeterminants == 12 || vdeterminants == 13) && (!(fup && fup2)|| isblank(skalarp.value) || isblank(skalarq.value))){
					alert("Please enter scalars p and q and use matrices A and B!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				...
				if((vpowersb == 1 || vpowersb == 2 || vpowersb == 3 || vpowersb == 4 ||  vpowersb == 8 || vpowersb == 12 || vpowersb == 13 || vpowersb == 14 || vpowersb == 15 || vinverses==2 || vinverses==14 || vtranspose==2 || vdeterminants==5 || vdeterminants==6 || vdeterminants==7 || vdeterminants==16) && !(vm2.value==vn2.value)){
...
<table width="100%" align="center">
  <tr>
    <td><form action="<?php echo "delproba.php?m1=$m1&n1=$n1&m2=$m2&n2=$n2&zielkeA=$zielkeA&zielkeB=$zielkeB&famous=$famous&famous2=$famous2&nacin=$nacin";?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <table width=98% border=0 align="center">
        <tr>
          <td width=25% height="472" align=right valign=top><table width="65" border="0" align="right">
                <tr>
                  <td width="443" height="24" align="right" valign="top" class="style15"><a href="index.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></td>
                </tr>
                <tr>
                  <td align="right" valign="top" class="style2"><span class="style15"><img src="images/liner.gif" alt="" width="200" height="1"></span></td>
                </tr>
                <tr>
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script><p>&nbsp;</p>
          ...
          <td width=75% valign=top align=left><table width=92% border=0 align="left">
              ...
              <tr>
                <td height="367" align=left valign=top><table width="96%" height="48" border="0" align="center" bgcolor="#FFFFFF">
                    
                    <tr bgcolor="#FF5604">
                      <td width="100%" height="21" align="left" valign="top" bgcolor="#FFFFFF"><p class="style28"><?php 
					  	  if($agree==11)
					  ...
					  ?>&nbsp;</p>
                        <p class="style3 style5"><span class="style26">
                          <?php if($m1!=null and $n1!=null) echo "matrix A"; ?>
                        </span></p>
                        <div align="left">
                          <?php
	for($i = 0; $i<$m1; $i++){
...
?>
                        ...
                        <p><span class="style26">
                          <?php if($m2!=null and $n2!=null) echo "matrix B"; ?>
                        </span></p>
                        <div align="left">
                          <?php
	for($i = 0; $i<$m2; $i++){
...
?>
                    ...
                    <tr bgcolor="#FF5604">
                      <td height="21" align="left" valign="top" bgcolor="#FFFFFF"><table width="300" align="left">
                        <tr>
                        ...
                        <tr>
                          <td colspan="10"><table width="80%" align="left">
                              <tr>
