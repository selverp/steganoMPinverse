...
echo $procenat . "%";?>" align="center" >
  <tr bgcolor="#FFFFFF">
    <td width="22%" rowspan="10" align="right" valign="top"><table width="70" border="0" align="right">
        ...
        <tr>
          <td width="204" class="style15"><img src="images/liner.gif" alt="" width="200" height="1"></td>
        </tr>
        <tr>
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script>&nbsp;</td>
    ...
    <p>&nbsp;</p></td>
    <td width="1%" rowspan="10" valign="top"><p>&nbsp;</p>
      <p align="left"><br>
        <br>
      </p>
    ...
    <td width=77% height="184" align=left valign=top><h1 align="left" class="style3"><span class="style35"><span class="style33">      The Matrix Library</span><br />
    </span></h1>
  ...
  <tr bgcolor="#FFFFFF">
    <td align="left" valign="top"><table width="388">
      <tr>
        <td colspan="3"><span class="style3 style5">MP Inverse</span></td>
      </tr>
      <tr>
        <td colspan="3"><?php
include "common.inc";
...
$Grevile=Grevile($matrixad);
$resenje=makeJeddim($Grevile,$n,$m);
input_solution($resenje,$idA,$m,$n);
createXML($n,$m,$idA,$Grevile);
//header("Location:vezaMP.247d.php?t=$t&p=$p&time_start=$time_start&idA=$idA");
prikaz_kad_nema($resenje,$n,$m);
//echo "<br>";
//echo "<br>";
...
?></td>
      ...
      <tr>
        <td width="28%">
            <div align="center">
              <?php
	echo "<a href=\"pdf/example.matrix1.php?idA=$idA\">Show matrix (PDF)</a>"; 
?>
              </div></td>
        <td width="52%">
            <div align="center">
