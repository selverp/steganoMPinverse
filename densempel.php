...
<table width="100%" align="center">
  <tr>
    <td><form action="densempel1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script><p>&nbsp;</p>
          ...
          <td width=75% valign=top align=left><table width=100% border=0 align="left">
              ...
              <tr>
                <td height="367" align=left valign=top><table width="100%" height="169" border="0" align="left" bgcolor="#FFFFFF">


                    <tr bgcolor="#FF5604">
                      <td height="34" colspan="4" valign="top" bgcolor="#FFFFFF"><h3 class="style13"><br />
                        <span class="style28">The instructions:</span><br />
                      </h3>
                        <ul class="style2">
                          <li class="style29"> Type number rows and&nbsp;columns of matrices end then enter elements; blank entries are set to zero<br />
                              <br />
                          </li>
                          ...
                          <li class="style29">Only click <span class="style21">Calculate</span> and ingoy<br />
                            <br />
                          </li>
                        </ul>                        </td>
                      </tr>
                    <tr bgcolor="#FF5604">
                      <td height="38" colspan="3" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix A</div></td>
                      </tr>
                    <tr>
                      <td width="21%" height="20" align="center" valign="middle" class="style22"><label>
                        <div align="right">m (rows)
                          </label>
                        </div>                        </td>
                      <td width="16%" align="center" valign="middle"><div align="left"><input name="m1" type="text" id="m1" size="3">
                          </div>
                      </label></td>
                      <td width="63%" align="left" valign="middle"><label>
                        <div align="left">
                          <input type="checkbox" name="zielkeA" id="zielkeA">
                          <span class="style39">check if test matri</span></div>                      </td>
                    </tr>
                    <tr>
                      <td height="21" align="center" valign="middle" class="style22"><div align="right">n (columns)</div></td>
                      <td height="21" align="center" valign="middle"><label>
                        <div align="left">
                      ...
                      <td align="left" valign="middle"><label>
                        <div align="left">
                          <input name="famous" type="text" id="famous" value="name of test">
                          </div>
                      </label></td>
                    </tr>
                    <tr bgcolor="#FF5604">
                      <td height="21" colspan="4" align="center" valign="middle" bgcolor="#FFFFFF"><label></label></td>
                      </tr>
                      ...
                      <td height="21" colspan="4" align="left" valign="top" bgcolor="#FFFFFF"><table width="70%" align="center">
                        <tr>
                          ...
                          <td width="10%"><div align="left" class="style20">
                              <input name="skalarr" type="text" class="style22" id="skalarr" size="4" readonly/>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">s&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="skalars" type="text" class="style22" id="skalars" size="4" readonly/>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">p&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="skalarp" type="text" class="style22" id="skalarp" size="4" readonly />
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">q&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="skalarq" type="text" class="style22" id="skalarq" size="4" readonly />
                          </div></td>
