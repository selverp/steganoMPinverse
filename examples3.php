...
.style44 {font-size: 12px; color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif; }
...
<table width="100%" align="center">
  <tr>
    <td><form action="examples4.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <table width=70% border=0 align="center">
        <tr>
          <td width=25% height="472" align=left valign=top><p align="right"><a href="index.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0" /><br />
            <br />
          </a></p>
              <table border="0" align="right">
                <tr>
                  <td width="443" height="11" valign="top" class="style15"><img src="images/liner.gif" alt="" width="200" height="1" /></td>
                </tr>
                <tr>
              ...
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  ...
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% height="153" align=left valign=top><h1 align="left" class="style3"><span class="style35"><span class="style33"><br />
                  The Matrix Library</span><br />
                </span></h1>
                  <h3 align="left" class="style34">Matrix algebra: matrix product, determinants, <br />
                    inverses, pawers of matrices, arithmetic, MP and Weighted inverse<br>
                  </h3>                  </td>
              </tr>
              <tr>
                <td height="6" align=left valign=top><img src="images/linel.gif" width="200" height="1" /></td>
              </tr>
              <tr>
                <td height="367" align=left valign=top><table width="96%" height="198" border="0" align="center" bgcolor="#FFFFFF">
                  <tr bgcolor="#FF5604">
                    <td height="34" colspan="4" bgcolor="#FFFFFF"><h3 class="style13"><br />
                  ...
                  <tr bgcolor="#FF5604">
                    <td height="26" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center" class="style45">
                        <div align="center">insert matrix A</div>
                    </div></td>
                    <td height="26" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                    <td height="26" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left"><span class="style45">insert matrix B</span></div></td>
                  </tr>
                  <tr>
                    <td width="26%" height="31" align="center" valign="middle" class="style22"><label>
                        <div align="right">m (rows) </div>
                      </label></td>
                    <td width="19%" align="center" valign="middle"><div align="left">
                        <input name="m1" type="text" id="m1" size="5" />
                    </div></td>
                    <td width="14%" align="center" valign="middle" class="style22"></label>
                        <div align="right">m (rows)</div></td>
                    <td width="41%" align="center" valign="middle"><div align="left">
                  ...
                  <tr>
                    ...
                    <td height="21" align="center" valign="middle"><div align="left">
                      <input name="n1" type="text" id="n1" size="5" />
                      </div>
                        </label></td>
                    <td align="center" valign="middle" class="style22"><div align="right">n (columns)</div></td>
                    <td align="center" valign="middle"><div align="left">
                        <input name="n2" type="text" id="n2" size="5" />
                    </div></td>
                  </tr>
                  <tr bgcolor="#FF5604">
                    <td height="28" colspan="4" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                  </tr>
                  <tr bgcolor="#FF5604">
                    ...
                    <td height="21" colspan="4" align="left" valign="top" bgcolor="#FFFFFF"><table width="70%" align="center">
                        <tr>
                          ...
                          <td width="10%"><div align="left" class="style20">
                              <input name="r" type="text" class="style22" id="r" size="4" readonly="readonly"/>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">s&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="s" type="text" class="style22" id="s" size="4" readonly="readonly"/>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">p&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="p" type="text" class="style22" id="p" size="4" readonly="readonly" />
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">q&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="q" type="text" class="style22" id="q" size="4" readonly="readonly" />
                          </div></td>
                        ...
                        <tr>
                          <td colspan="10"><table width="100%">
                              <tr>
                                <td width="19%" height="31"><div align="left">
                                    <select name="arithmetic2" class="style21" id="arithmetic2" disabled="disabled">
                              ...
                              <tr>
                                <td colspan="4"><div align="left"><span class="style44">Select on or more operations to be perfored and click Calculate!</span></div></td>
                                <td><div align="right">
