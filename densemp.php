...
.style41 {color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; }
...
<form action="uploadMP.77d.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width=69% border=0 align="center">
    <tr>
      <td width=25% height="635" align=left valign=top><p align="right"><a href="index.php"><br>
...
<ul id="qm0" class="qmmc">
	...
	<li><a class="qmparent" href="javascript:void(0)">SPARSE matrix</a>
        ...
        <ul>
			  <li><a href="javascript:void(0)">Browse...</a></li>
			  <li><a href="javascript:void(0)">Element by element</a></li>
			  <li><a href="javascript:void(0)">Textare</a></li>
			  </ul>
        </li>
		</ul></li>
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script><p>&nbsp;</p>
      ...
      <td width=75% valign=top align=left><table width=100% border=0 align="left">
        <tr>
          <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p></td>
          <td width=98% height="227" align=left valign=top><h1 align="left" class="style3"><span class="style26"><span class="style33"><br>
            ...
            Weighted invers </h3></td>
        </tr>
        <tr>
          <td height="3" align=left valign=top><img src="images/linel.gif" width="200" height="1"></td>
        </tr>
        <tr>
          <td height="367" align=left valign=top><table width="97%" height="187" border="0" align="left" bgcolor="#FFFFFF">
              <tr bgcolor="#FF5604">
                <td height="34" colspan="2" bgcolor="#FFFFFF"><h3 class="style13"><br>
                        <span class="style28">The instructions:</span><br>
                  </h3>
                    <ul class="style2">
                      <li class="style29">Click on the button Browse... and find file with the <a href="testmatrix.php">matrices</a> on your computer <br>
                          <br>
                      <li class="style29">Chack chackbox if matrix is test<br>
                          <br>
                      <li class="style29">Only click <span class="style21">Calculate</span> and injoy
                    </ul>
                  <p>&nbsp;</p>                  </td>
              </tr>
              <tr bgcolor="#FF5604">
                <td height="26" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix A</div></td>
                <td width="48%" height="26" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
              </tr>
              <tr>
                <td width="51%" height="43" align="center" valign="middle"><div align="center"><span class="style1 style4 style23">
              ...
              <tr bgcolor="#FF5604">
                <td height="28" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left">
                  ...
                  <span class="style39">check if test matrix</span></div></td>
                <td height="28" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
              </tr>
              <tr bgcolor="#FF5604">
                <td height="21" colspan="2" align="left" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
              </tr>
              <tr bgcolor="#FF5604">
                <td height="21" colspan="2" align="left" valign="top" bgcolor="#FFFFFF"><table width="95%" align="center">
                    <tr>
    ...
    <tr>
      <td height="38" colspan="2" align=left valign=top><table width=581 border=0 align="center">
        <tr>
