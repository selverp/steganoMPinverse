...
function posalji() {
	...
	if(fup.value==null || fup.value!=0){
		document.getElementById("form1").submit();
	}
	else{
		alert ("Please enter the number!" +fup.value);
	}
}
</script>
<style type="text/css">
...
<table width="100%" align="center">
  <tr>
    <td><form action="densemptex1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script><p>&nbsp;</p>
          ...
          <td width=75% valign=top align=left><table width=100% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  ...
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% height="205" align=left valign=top><h1 align="left" class="style3"><span class="style35"><span class="style33">                  The Matrix Library</span><br />
                </span></h1>
              ...
              <tr>
                <td height="367" align=left valign=top><table width="100%" height="153" border="0" align="left" bgcolor="#FFFFFF">
                    ...
                    <tr bgcolor="#FF5604">
                      <td height="21" colspan="4" align="center" valign="middle" bgcolor="#FFFFFF"><label>
                        <div align="left">
                          <textarea name="textarea" id="textarea" cols="45" rows="7" style="overflow: scroll; overflow-y: scroll; overflow-x: scrool; background:#fffcf0"></textarea>
                          </div>
                      </label>
                        <label></label></td>
                      </tr>
                    <tr bgcolor="#FF5604">
                      <td width="23%" height="8" bgcolor="#FFFFFF"><div align="right"><span class="style40">Values are delimited by:</span></div></td>
                      ...
                      <td width="57%" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                      <td width="3%" height="21" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    
                    <tr bgcolor="#FF5604">
                      <td height="21" colspan="4" align="left" valign="top" bgcolor="#FFFFFF"><table width="70%" align="left">
                        <tr>
                          <td class="style22">&nbsp;</td>
                          <td>&nbsp;</td>
                          <td class="style22">&nbsp;</td>
