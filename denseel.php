...
function posalji() {
	...
	var k=isNaN(m1.value);
	//var v2 = parseFloat(clozinka.value);
	var k2=isNaN(n1.value);
	//var v3 = parseFloat(plozinka.value);
	var k3=isNaN(m2.value);
	var k4=isNaN(n2.value);
	if((!k && !k2 && (m1.value != null) && (m1.value != "") && !isblank(m1.value) && (n1.value != null) && (n1.value != "") && !isblank(n1.value)&& (((m2.value == null) || (m2.value == "") || isblank(m2.value)) && ((n2.value == null) || (n2.value == "") || isblank(n2.value))))|| (!k3 && !k4 && (m2.value != null) && (m2.value != "") && !isblank(m2.value) && (n2.value != null) && (n2.value != "") && !isblank(n2.value)&& (((m1.value == null) || (m1.value == "") || isblank(m1.value)) && ((n1.value == null) || (n1.value == "") || isblank(n1.value)))) || (!k && !k2 && !k3 && !k4 && (m1.value != null) && (m1.value != "") && !isblank(m1.value) && (n1.value != null) && (n1.value != "") && !isblank(n1.value)&& (m2.value != null) && (m2.value != "") && !isblank(m2.value) && (n2.value != null) && (n2.value != "") && !isblank(n2.value))){
		document.getElementById("promenaLozinke").submit();
	}
...
.style39 {font-size: 13px; font-family: Arial, Helvetica, sans-serif; }
.style42 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #FF0000; font-weight: bold; }
.style43 {font-size: 12px; color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif; }
-->
</style>
</HEAD>
...
<table width="100%" align="center">
  <tr>
    <td><form name="promenaLozinke" id="promenaLozinke" action="<?php 
	$nacin = "element";
	echo "denseel1.php?nacin=$nacin";?>" method="post">
      <table width=98% border=0 align="center">
        <tr>
          <td width=25% height="472" align=left valign=top><p align="right"><a href="index.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></p>
              <table border="0" align="right">
                <tr>
                  <td width="443" align="right" valign="top" class="style15"><img src="images/liner.gif" alt="" width="200" height="1"></td>
                </tr>
                <tr>
                  <td valign="top" class="style2"><table width="100%">
                        <tr>
                          <td height="212" align="right" valign="top"><!-- *** MyCSSMenu copyright (c) 2007, MyCSSMenu. All Rights Reserved.
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script>&nbsp;</td>
          ...
          <td width=75% valign=top align=left><table width=92% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  ...
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% height="202" align=left valign=top><h1 align="left" class="style3"><br>
                        <span class="style26"><span class="style38">                        The Matrix Library</span><br>
                      </span></h1>
              ...
              <tr>
                <td height="367" align=left valign=top><table width="96%" height="187" border="0" align="center" bgcolor="#FFFFFF">


                    <tr bgcolor="#FF5604">
                      <td height="34" colspan="6" bgcolor="#FFFFFF"><h3 class="style13"><br>
                        <span class="style28">The instructions:</span><br>
</h3>
                        <ul class="style2">
                          <li class="style29">Chose <span class="style32">operation</span> on the left side, different for dense and sparse matrices, and then<br>
                            <br>
                          <li class="style29"> Chack chackbox if matrix is test<br>
                              <br>
                          <li class="style29"> Type number rows and&nbsp;columns of matrices end enter elements;<br>
                            <br>
                            <br>
                        </ul>                        </td>
                      </tr>
                    <tr bgcolor="#FF5604">
                      <td height="26" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center" class="style34">
                        insert matrix A</div></td>
                      <td width="14%" height="26" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                      <td width="12%" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                      <td width="15%" height="26" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left"><span class="style34">insert matrix B</span></div></td>
                      <td width="23%" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                      <td width="21%" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="20" align="center" valign="middle" class="style22"><input type="checkbox" name="zielkeA" id="zielkeA">
                        <span class="style37">test matrix</span></td>
                      <td colspan="2" align="center" valign="middle"><div align="left">
                        <input name="famous" type="text" id="famous" value="name of matrix" size="16">
                      </div></td>
                      <td align="center" valign="middle" class="style22"><div align="left">
                        <input type="checkbox" name="zielkeB" id="zielkeB">
                        <span class="style37">test matrix</span></div></td>
                      <td colspan="2" align="center" valign="middle"><div align="left">
                        <input name="famous2" type="text" id="famous2" value="name of matrix" size="16">
                      </div></td>
                    </tr>
                    <tr>
                      <td width="15%" height="20" align="center" valign="middle" class="style22"><label>
                        <div align="right">m (rows)</div>
                      </label></td>
                      <td colspan="2" align="center" valign="middle"><label>
                        <div align="left">
                          <input name="m1" type="text" id="m1" size="3">
                        </div>
                      </label></td>
                      <td align="center" valign="middle" class="style22"></label>
                          <div align="right">m (rows)</div></td>
                      <td colspan="2" align="center" valign="middle"><div align="left">
                          <input name="m2" type="text" id="m2" size="3">
                      </div></td>
                    </tr>
                    <tr>
                      <td height="21" align="center" valign="middle" class="style22"><div align="right">n (columns)</div></td>
                      <td height="21" colspan="2" align="center" valign="middle"><label>
                        <div align="left">
                          <input name="n1" type="text" id="n1" size="3">
                          </div>
                      </label></td>
                      <td align="center" valign="middle" class="style22"><div align="right">n (columns)</div></td>
                      <td colspan="2" align="center" valign="middle"><div align="left">
                    ...
                    <tr bgcolor="#FF5604">
                      <td height="21" colspan="6" align="left" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    <tr bgcolor="#FF5604">
                      <td height="21" colspan="6" align="left" valign="top" bgcolor="#FFFFFF"><table width="70%" align="left">
                        <tr>
                          <td width="4%" class="style22"><div align="right" class="style25">r&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="r" type="text" class="style22" id="r" size="3" readonly/>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">s&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="s" type="text" class="style22" id="s" size="3" readonly/>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">p&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="p" type="text" class="style22" id="p" size="3" readonly />
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">q&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="q" type="text" class="style22" id="q" size="3" readonly />
                          </div></td>
                        ...
                        <tr>
                          <td colspan="10"><table width="100%" align="left">
                              <tr>
                                <td width="17%" height="31"><div align="left">
                                  <select name="arithmetic2" class="style21" id="arithmetic2" disabled>
                                    <option selected="selected">arithmetic</option>
                                    ...
                                    <option value=" r A + s B "> r A + s B </option>
                                  </select>
                                </div></td>
                              ...
                              <tr>
                                <td colspan="4"><div align="left"><span class="style43">Select on or more operations to be perfored and click Calculate!</span></div></td>
                                <td colspan="2">
                                    <div align="left">
