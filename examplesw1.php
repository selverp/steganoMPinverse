...
.style47 {font-size: 14px; color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif;}
.style48 {font-size: 12px; color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif; }
-->
</style>
</HEAD>
<body bgcolor="#FFFFFF" TEXT="#171717" VLINK="#EA6A13" ALINK="#EA6A13" LINK="#C73100">
<form name="form1" method="post" action="<?php echo "uploadwexam.php?m1=$m1&n1=$n1&m2=$m2&n2=$n2&m3=$m3&n3=$n3";?>">
  <table width="95%" align="center" >
    <tr bgcolor="#FFFFFF">
      <td width="23%" rowspan="3" align="left" valign="top"><table width="70" border="0" align="right">
          
          <tr>
            <td align="right" valign="top" class="style15"><a href="index.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></td>
          </tr>
          <tr>
            <td width="200" align="right" valign="top" class="style15"><img src="images/liner.gif" alt="" width="200" height="1"></td>
          </tr>
          <tr>
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script>&nbsp;</td>
      ...
      <td height="179" colspan="2" align=left valign=top><h1 align="left" class="style3"><span class="style26"><span class="style38"><br>
    ...
    <tr bgcolor="#FFFFFF">
      <td colspan="2" align="left" valign="top"><p class="style3 style5"><span class="style46"><br>
      </span> </p>
...
?>
        ...
        <p><span class="style26"><?php if($m2!=null and $n2!=null) echo "matrix M"; ?></span></p>
        <div align="left">
<?php
	$edim2=rand(1,1000);
	for($i = 0; $i<$m1; $i++){
		for($j=0; $j<$m1; $j++){
			...
			echo  "<input name=matrixb[] type=text size=\"3\" maxlength=\"5\" value=\" $r\">";
			echo "&nbsp;&nbsp;&nbsp;";
		}
		echo "<br>";
	}
?>
        ...
        <p><span class="style26">
          <?php if($m2!=null and $n2!=null) echo "matrix N"; ?>
        </span></p>
        <div align="left">
<?php
	$edim3=rand(1,1000);
	for($i = 0; $i<$n1; $i++){
		for ($j=0; $j<$n1; $j++){
			...
			echo  "<input name=matrixc[] type=text size=\"3\" maxlength=\"5\" value=\" $p\">";
			echo "&nbsp;&nbsp;&nbsp;";
		}
		echo "<br>";
	}
      ...
      <td colspan="4" align="center" valign="middle"><table width="300" align="center">
        ...
        <tr>
          <td colspan="10"><table width="100%">
              ...
              <tr>
                <td colspan="4"><div align="left"><span class="style48">Select on or more operations to be perfored and click Calculate!</span></div></td>
                <td><div align="right">
