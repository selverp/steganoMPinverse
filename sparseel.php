...
<table width="100%" align="center">
  <tr>
    <td><form action="sparseel1.php" method="post" enctype="multipart/form-data" name="form1">
          ...
          <td width=75% valign=top align=left><table width=100% border=0 align="left">
              <tr>
                ...
                <td width=98% align=left valign=top><h1 align="left" class="style3"><br>
                  <span class="style35"><span class="style33">The Matrix Library</span><br>
                    </span></h1>
              ...
              <tr>
                <td height="367" align=left valign=top><table width="100%" height="271" border="0" align="left" bgcolor="#FFFFFF">


                    <tr bgcolor="#FF5604">
                      <td height="34" colspan="5" bgcolor="#FFFFFF"><h3 class="style13"><span class="style28">                        The instructions:</span><br>
</h3>
                        <ul class="style2">
                          <li class="style29">Chose <span class="style32">operation</span> on the left side, different for dense and sparse matrices, and then<br>
                            <br>
                          <li class="style29"> Type number rows and&nbsp;columns of matrices end enter elements;                          
                          </ul>                        </td>
                      </tr>
                    <tr bgcolor="#FF5604">
                      <td height="22" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix A</div></td>
                      <td height="22" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                      <td height="22" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix B</div></td>
                    </tr>
                    <tr>
                      <td width="17%" height="43" align="center" valign="middle" class="style22"><label>
                      ...
                      <td width="16%" align="center" valign="middle" class="style22"></label>
                          <div align="right">m (rows)</div></td>
                      <td width="48%" align="center" valign="middle"><div align="left">
                          <input name="m2" type="text" id="m2" size="5">
                      </div></td>
                    </tr>
                    <tr>
                      <td height="43" align="center" valign="middle" class="style22"><div align="right">n (columns)</div></td>
                      <td height="43" align="center" valign="middle"><label>
                        <div align="left">
                    ...
                    <tr bgcolor="#FF5604">
                      <td height="21" colspan="5" align="left" valign="top" bgcolor="#FFFFFF"><table width="70%" align="center">
                        <tr>
                          <td class="style22">&nbsp;</td>
                          <td>&nbsp;</td>
                          <td class="style22">&nbsp;</td>
                        ...
                        <tr>
                          <td colspan="10"><table width="100%">
                              <tr>
                                <td width="21%" height="31"><select name="arithmetic" class="style21" id="arithmetic">
