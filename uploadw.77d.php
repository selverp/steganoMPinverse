...
{
	header("Location:vezaweighted.24777.php?t=$ta&p=$pa&time_start=$time_start&rezaA=$idA&rezaB=$idB&rezaC=$idC");
...
{
	header("Location:vezaweighted.14777.php?t=$ta&p=$pa&time_start=$time_start&rezaA=$idA&rezaB=$idB&rezaC=$idC");
}
