...
<form name="form1" method="post" action="<?php echo "uploadMP.7del.php?textmp=1";?>">
  <table width="93%" align="center" >
    <tr bgcolor="#FFFFFF">
      <td width="22%" rowspan="3" align="left" valign="top"><p align="right"><a href="index.php"><img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0" /></a></p>
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script><p>&nbsp;</p>
      ...
      <td height="153" colspan="2" align=left valign=top><h1 align="left" class="style3"><span class="style31"><span class="style33"><br>
        The Matrix Library</span><br>
      </span></h1>
        <h3 align="left" class="style30">Matrix algebra: matrix product, determinants, <br>
    ...
    <tr bgcolor="#FFFFFF">
      <td colspan="2" align="left" valign="top"><span class="style28"><br>
          <strong>The instructions:</strong></span><br>
        <ul class="style2">
          <li class="style29">Enter elements; blank entries are set to zero<br>
          <br />
        </li>
        ...
        <li class="style29">Only click <span class="style21">Calculate</span> and ingoy</li>
      </ul>
      <p class="style3 style5">&nbsp;</p>
        <p> <span class="style13"><? if($m1!=null and $n1!=null) echo "matrica A"; ?></span></p>
        <div align="left">
          <?php
      ...
      <td colspan="4" align="center" valign="middle"><table width="300" align="center">
        ...
        <tr>
          <td><span class="style22">
            <input type="hidden" name="m1" id="hm1" value="<?php echo $m1;?>">
          </span></td>
          <td>&nbsp;</td>
          <td><span class="style22">
            <input type="hidden" name="n1" id="m1" value="<?php echo $m1;?>">
          </span></td>
          <td>&nbsp;</td>
          <td><span class="style22">
        ...
        <tr>
          <td align=left valign=top><div align="center">
              <p><span class="style2">&nbsp;&nbsp;<span class="style19"><span class="style6">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span></span><span class="style6"><A HREF="#">FAQs</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp; <A HREF="#">legal</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp; <A HREF="kontakt/mailform.php">email us</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp; <A HREF="sparse.php">sparse</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span> <span class="style6"><A HREF="dense.php">dense</A>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>&nbsp;<BR>
                    <br>
                    <span class="style35"><span class="style29"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copyright &reg; 2009 Selver H. Pepic  Inc. All rights reserved&nbsp;</span>&nbsp;</span><span class="style19">&nbsp;&nbsp;&nbsp;</span></span></p>
          </div></td>
        </tr>
      </table></td>
    </tr>
