...
.style39 {font-size: 14px; color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif;}
...
<table width="100%" align="center">
  <tr>
    <td><form action="examplesw1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script><p>&nbsp;</p>
          ...
          <td width=75% valign=top align=left><table width=100% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  ...
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% height="205" align=left valign=top><h1 align="left" class="style3"><br>
              ...
              <tr>
                <td height="367" align=left valign=top><table width="96%" height="168" border="0" align="center" bgcolor="#FFFFFF">
                    ...
                    <tr bgcolor="#FF5604">
                      ...
                      <td height="26" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    <tr>
                      <td width="14%" height="31" align="right" valign="middle" class="style22"><label>
                      ...
                      <td width="1%" align="center" valign="middle" class="style22">&nbsp;</td>
                      <td width="73%" align="center" valign="middle">&nbsp;</td>
                    </tr>
                    
                    <tr>
                      <td height="21" align="right" valign="middle" class="style22"><div align="right">n (columns)</div></td>
                      <td height="21" align="left" valign="middle"><div align="left"><input name="n1" type="text" id="n1" size="5">
                          </div>
                      </label></td>
                      <td align="center" valign="middle" class="style22">&nbsp;</td>
                      <td align="center" valign="middle">&nbsp;</td>
                    </tr>
                    
                    
                    <tr bgcolor="#FF5604">
                      <td height="21" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                      ...
                      <td height="21" colspan="4" align="left" valign="top" bgcolor="#FFFFFF"><table width="70%" align="center">
                        <tr>
                          ...
                          <td width="10%"><div align="left" class="style20">
                              <input name="r" type="text" class="style22" id="r" size="4" readonly/>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">s&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="s" type="text" class="style22" id="s" size="4" readonly/>
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">p&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="p" type="text" class="style22" id="p" size="4" readonly />
                          </div></td>
                          <td width="4%" class="style22"><div align="right" class="style25">q&nbsp;=&nbsp;</div></td>
                          <td width="10%"><div align="left" class="style20">
                              <input name="q" type="text" class="style22" id="q" size="4" readonly />
                          </div></td>
