...
$nacin="text";
	if($select == 'Commas') $textarea = str_replace(","," ",$textarea);
	//if($select2 == 'Spaces') $textarea2 = str_replace(" ",",",$textarea2);
	//if($select == 'Commas') $textarea = str_replace(" ",",",$textarea);
	if($select2 == 'Commas') $textarea2 = str_replace(","," ",$textarea2);
	$m1=dim_m($textarea);
	$n1=dim_n($textarea);
	$m2=dim_m($textarea2);
	$n2=dim_n($textarea2);
...
function posalji() {
	...
	var vm1 = document.getElementById("m1");
	var vn1 = document.getElementById("n1");
	var vm2 = document.getElementById("m2");
		...
		if((varithmetic!=0 || vpowersa!=0 || vpowersb!=0 || vproducts!=0 || vtranspose!=0 || vdeterminants!=0 || vinverses!=0)){
			if(!k && !k2 && !k3 && !k4){
				...
				if((varithmetic == 1 || varithmetic == 2 || varithmetic == 3 || varithmetic == 7) && !(vn2.value==vn1.value && vm2.value==vm1.value)){
					alert("Dimension of the matrices must be equal!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				...
				if(vpowersa == 8 && (!(fup)|| isblank(skalarp.value) || isblank(skalarq.value))){
					alert("Please enter scalars p and q and matrix A!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
				...
				if((vpowersa != 0) && !(fup)){
					alert("Please enter the matrix A!"); 
					document.form1.arithmetic.focus(); 
					//document.getElementById("form1").submit();
					return false;
				}
...
<table width="100%" align="center">
  <tr>
    <td><form action="<?php echo "texlproba.php?nacin=$nacin&textarea=$textarea&textarea2=$textarea2";?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
<ul class="qmmc">
  ...
  <li></li>
          ...
          <td width=75% valign=top align=left><table width=92% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                  ...
                  <p><img src="images/fadeup.gif" width="1" height="92"></p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>                  </td>
                <td width=98% height="208" align=left valign=top><h1 align="left" class="style3"><br>
                        <span class="style26"><span class="style38">The Matrix Library</span><?php echo $m1;?><br>
                      </span></h1>
              ...
              <tr>
                <td height="367" align=left valign=top><p class="style22"><span class="style22"><?php 
					  	  if($agree==11)
					  ...
					  ?></span> </p>
                  <p> <span class="style26"><?php if($m1!=0 && $n1!=0) echo "matrix A"; ?></span></p>
                  <div align="left">
                    <?php
	if($m1!=0 && $n1!=0){
	$matrixa=textarea($textarea);
	$matrixa = implode($matrixa,",");
	//prikaz_resenja_textarea($matrixa,$m1,$n1);
	matrx_in_textarea($matrixa,$m1,$n1);
	}
?>
                  </div>
                  <p><span class="style26"><?php if($m2!=0 && $n2!=0) echo "matrix B"; ?></span></p>
                  <div align="left">
                    <?php
	if($m2!=0 && $n2!=0){
	$matrixb=textarea($textarea2);
	$matrixb = implode($matrixb,",");
	//prikaz_resenja_textarea($matrixb,$m2,$n2);
	matrx_in_textarea($matrixb,$m2,$n2);
	}
?>
                  </div>
                  <p>&nbsp;</p>
                  <table width="300" align="left">
                    ...
                    <tr>
                      <td><span class="style22">
                        <input type="hidden" name="m1" id="m1" value="<?php echo $m1;?>">
                      </span></td>
                      <td>&nbsp;</td>
                      <td><span class="style22">
                      ...
                      <td>&nbsp;</td>
                      <td><span class="style22">
                        <input type="hidden" name="m2" id="m2" value="<?php echo $m2;?>">
                      </span></td>
                      <td>&nbsp;</td>
                      <td><span class="style22">
                        <input type="hidden" name="n2" id="n2" value="<?php echo $n2;?>">
                      </span></td>
                      <td><input type="hidden" name="textarea" id="textarea" value="<?php echo $textarea;?>"></td>
                      <td colspan="2" class="style22"><input type="hidden" name="textarea2" id="textarea2" value="<?php echo $textarea2;?>"></td>
                    </tr>
                    <tr>
                      <td colspan="10"><table width="100%">
                          ...
                          <tr>
                            <td colspan="4"><div align="center">
                              <div align="left"><span class="style44">Select on or more operations to be perfored and click Calculate!</span></div>
                            </div></td>
                            <td><div align="right">
