...
header("Location:vezaweighted.24777.php?m=$ta&n=$pa&time_start=$time_start&idA=$idA&idB=$idB&idC=$idC");
	//prikaz vec unete matrice AMN
	/*	echo "postoje sve";
		echo "<br>"; 
		echo "$zielkeA";*/	//echo "selver";

else
header("Location:vezaweighted.1477.php?m=$ta&n=$pa&time_start=$time_start&idA=$idA&idB=$idB&idC=$idC");
