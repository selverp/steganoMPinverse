...
function posalji() {
	var fup = document.getElementById("textarea");
	var fup2 = document.getElementById("textarea2");
	var fup3 = document.getElementById("textarea3");
	if((fup.value==null || fup.value!=0) && (fup2.value==null || fup2.value!=0) && (fup3.value==null || fup3.value!=0)){
...
.style39 {color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; }
...
<table width="100%" align="center">
  <tr>
    <td><form action="densewtex1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <table width=70% border=0 align="center">
        <tr>
          <td width=25% height="472" align=left valign=top><p align="right"><a href="index.php"><br>
            <img src="images/logoi2.gif" alt="home page" width="185" height="177" border="0"></a></p>
              <div align="right">
...
<script type="text/javascript">if (window.name=="qm_launch_visual"){document.write('<scr'+'ipt type="text/javascript" src="http://www.mycssmenu.com/qmv6/qm_visual.js"></scr'+'ipt>')}</script><p>&nbsp;</p>
          ...
          <td width=75% valign=top align=left><div align="right">
            <table width=100% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                      ...
                      <p>&nbsp;</p>
                      <p>&nbsp;</p>                  </td>
                    <td width=98% height="218" align=left valign=top><h1 align="left" class="style3"><span class="style35"><span class="style33"><br>
              ...
              <tr>
                <td height="367" align=left valign=top><table width="100%" height="290" border="0" align="center" bgcolor="#FFFFFF">
                  
                  
                  <tr bgcolor="#FF5604">
                    <td height="34" colspan="5" bgcolor="#FFFFFF"><h3 class="style13"><br>
                      <span class="style28">The instructions:</span><br>
                      </h3>
                            <ul class="style2">
                              <li class="style29">Click on the button Browse.. and find file with the <a href="testmatrix.php">matrices</a> on your computer
                              <br>
                              <br>
                              <li class="style29">Chack chack box if matrix is test<br>
                                <br>
                              <li class="style29">Click <span class="style21">Calculate</span> and enjoy
                            </ul>
                          <p>&nbsp;</p>                        </td>
                        </tr>
                  <tr bgcolor="#FF5604">
                    <td height="26" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix A</div></td>
                          <td height="26" colspan="3" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left">
                            <input type="checkbox" name="zielkeA" id="zielkeA">
                            <span class="style39">check if test matrix</span></div>                            <div align="left"></div></td>
                        </tr>
                  <tr>
                    <td height="43" colspan="2" align="center" valign="middle"><label>
                    <textarea name="textarea" id="textarea" cols="45" rows="5"></textarea>
                    </label>
                    <label></label></td>
                          <td colspan="2" align="left" valign="middle"><label></label></td>
                        </tr>
                  
                  <tr bgcolor="#FF5604">
                    <td height="28" align="center" valign="middle" bgcolor="#FFFFFF"><div align="right"><span class="style40">Values are delimited by:</span></div></td>
                    <td width="12%" height="28" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left">
                    ...
                    <td width="1%" rowspan="3" align="left" valign="top" bgcolor="#FFFFFF" class="style26"><label></label></td>
                  </tr>
                  <tr bgcolor="#FF5604">
                    <td height="28" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix M</div></td>
                          <td height="28" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix N</div></td>
                        </tr>
                  <tr bgcolor="#FF5604">
                    <td colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><label>
                      <label>
                      <textarea name="textarea2" id="textarea2" cols="45" rows="5"></textarea>
                      </label>                      </label></td>
                          <td height="21" colspan="2" align="left" valign="middle" bgcolor="#FFFFFF" class="style26"><label>
                            <textarea name="textarea3" id="textarea3" cols="45" rows="5"></textarea>
                          </label></td>
                        </tr>
                  <tr bgcolor="#FF5604">
                    <td height="21" align="left" valign="top" bgcolor="#FFFFFF"><div align="right"><span class="style40">Values are delimited by:</span></div></td>
                    <td height="21" align="left" valign="top" bgcolor="#FFFFFF"><div align="left">
                      <select name="select2" id="select2">
                        <option selected="selected">Spaces</option>
                        <option>Commas</option>
                      </select>
                    </div></td>
                    <td width="25%" height="21" align="left" valign="top" bgcolor="#FFFFFF"><div align="right"><span class="style40">Values are delimited by:</span></div></td>
                    <td width="23%" align="left" valign="top" bgcolor="#FFFFFF"><div align="left">
                  ...
                  <tr bgcolor="#FF5604">
                    <td height="21" colspan="4" align="left" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
                    <td height="21" align="left" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
                  </tr>
                  <tr bgcolor="#FF5604">
                    <td height="21" colspan="4" align="left" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
                  ...
                  <tr bgcolor="#FF5604">
                    <td height="21" colspan="4" align="left" valign="top" bgcolor="#FFFFFF"><table width="70%" align="center">
                      <tr>
                        <td width="4%" class="style22"><div align="right" class="style25">r&nbsp;=&nbsp;</div></td>
                              <td width="10%"><div align="left" class="style20">
                                <input name="skalarr" type="text" class="style22" id="skalarr" size="3" readonly/>
                                </div></td>
                              <td width="4%" class="style22"><div align="right" class="style25">s&nbsp;=&nbsp;</div></td>
                              <td width="10%"><div align="left" class="style20">
                                <input name="skalars" type="text" class="style22" id="skalars" size="3" readonly/>
                                </div></td>
                              <td width="4%" class="style22"><div align="right" class="style25">p&nbsp;=&nbsp;</div></td>
                              <td width="10%"><div align="left" class="style20">
                                <input name="skalarp" type="text" class="style22" id="skalarp" size="3" readonly/>
                                </div></td>
                              <td width="4%" class="style22"><div align="right" class="style25">q&nbsp;=&nbsp;</div></td>
                              <td width="10%"><div align="left" class="style20">
                                <input name="skalarq" type="text" class="style22" id="skalarq" size="3" readonly />
                                </div></td>
                        ...
                        <td colspan="10"><table width="100%">
                          <tr>
                            <td height="31"><div align="left">
                              <select name="arithmetic" class="style21" id="arithmetic" disabled="disabled">
                                ...
                                <option value="rAsumsB"> r A + s B </option>
                                    ...
                                    <td><div align="left">
                                      <select name="powersa" class="style21" id="powersa" disabled="disabled">
                                    ...
                                    <td><div align="left">
                                      <div align="left">
                                        <select name="powersb" class="style21" id="powersb" disabled="disabled">
                                    ...
                                    <td><div align="left">
                                      <select name="products" class="style21" id="products" disabled="disabled">
                          ...
                          <tr>
                            <td><div align="left">
                              <select name="transpose" class="style21" id="transpose" disabled="disabled">
                                ...
                                <option value="A^T.B^T"> A^T . B^T </option>
                                    ...
                                    <td><div align="left">
                                      <select name="determinants" class="style21" id="determinants" disabled="disabled">
                                    ...
                                    <td><div align="left">
                                      <select name="inverses" class="style21" id="inverses" disabled="disabled">
                          ...
                          <tr>
                            <td colspan="4"><div align="left"><span class="style39">Chose an option from List/Menu and click Calculate!</span></div></td>
                                    <td><div align="right">
                                      <input type="button" name="Submit2" class="style37" id="button" value="Calculate!" onKeyDown="javascript: posalji();" onClick="javascript: posalji();" />
                                    </div></td>
                                  </tr>
                          <tr>
                            <td>&nbsp;</td>
