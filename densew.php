...
function posalji() {
	...
	var fup3 = document.getElementById("userfile3");
	...
	if(fup.value && fup2.value && fup3.value){	
		document.getElementById("form1").submit();
		//return (false);
	}
	else{
		alert ("Please enter matrices!");
		return (false);
	}
}
</script>
...
.style40 {font-size: 14px; color: #006600; font-family: Verdana, Arial, Helvetica, sans-serif;}
-->
</style>
</HEAD>
<body bgcolor="#FFFFFF" TEXT="#171717" VLINK="#EA6A13" ALINK="#EA6A13" LINK="#C73100">
<table width="100%" align="center">
  <tr><?php /*za testiranje ne class matrica koristimo fajl proba.matrix.bez.klasa.php*/;?>
    <td><form action="uploadw.77d.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            ...
            <table width=100% border=0 align="left">
              <tr>
                <td width=2% height="635" rowspan="3" align=left valign=top><p>&nbsp;</p>
                      ...
                      <p>&nbsp;</p>
                      <p>&nbsp;</p>                  </td>
                    <td width=98% height="221" align=left valign=top><h1 align="left" class="style3"><span class="style35"><span class="style33"><br>
              ...
              <tr>
                <td height="367" align=left valign=top><table width="100%" height="210" border="0" align="center" bgcolor="#FFFFFF">
                  ...
                  <tr bgcolor="#FF5604">
                    <td width="19%" height="26" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix A</div></td>
                          <td height="26" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left">
                            <input type="checkbox" name="zielkeA" id="zielkeA">
                            <span class="style39">check if test matrix</span></div>                            <div align="left"></div></td>
                        </tr>
                  <tr>
                    <td height="43" colspan="2" align="center" valign="middle"><div align="left"><span class="style1 style4 style23">
                  ...
                  <tr bgcolor="#FF5604">
                    <td height="28" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix M</div></td>
                          <td height="28" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left" class="style36 style2">insert matrix N</div></td>
                          <td width="1%" rowspan="2" align="left" valign="top" bgcolor="#FFFFFF" class="style26"><label></label></td>
                        </tr>
                  <tr bgcolor="#FF5604">
                    <td colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><label>
                      
                        <div align="left"><span class="style1 style4 style23">
                          <input type="hidden" name="action2" value="upload2" />
                          </span>
                            <input type="file" name="userfile2" id="userfile2">
                        </div>
                        </label></td>
                          <td width="60%" height="21" align="left" valign="middle" bgcolor="#FFFFFF" class="style26"> <div align="left"><span class="style1 style4">
                            <input type="hidden" name="action3" value="upload3" />
                            </span>
                  ...
                  <tr bgcolor="#FF5604">
                    <td height="21" colspan="3" align="left" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
                          <td height="21" align="left" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                  <tr bgcolor="#FF5604">
                    <td height="21" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="70%" align="center">
                      <tr>
                      ...
                      <tr>
                        <td colspan="10"><table width="100%">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                                    <td colspan="3" class="style40">Chose an option from List/Menu and click Calculate!</td>
                                    <td><div align="right">
